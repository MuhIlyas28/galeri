        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="col-2">
                    ...
                    <h4>Nama User : <?php echo $_SESSION['a_global']['username'] ?><br />
                    ...
                    <div id="comments-container" class="comments-container">
                        ...
                        ?>
                            <div class="comment">
                                <h4>Nama Pengirim : <?php echo isset($_SESSION['a_global']['username']) ? $_SESSION['a_global']['username'] : 'Nama Pengguna Tidak Tersedia'; ?></h4>
                    ...
                    <!-- Form komentar -->
                    <form action="proses-komentar.php" method="post" class="comment-form" onsubmit="return validateComment()">
                        <input type="hidden" name="image_id" value="<?php echo $p->image_id; ?>">
                        <textarea name="comment" id="comment" placeholder="Tambahkan komentar Anda"></textarea>
                    ...
                    <!-- Tombol Like -->
                    <form action="proses-like.php" method="post">
                        <input type="hidden" name="image_id" value="<?php echo $p->image_id; ?>">
                        <button type="submit" name="submit" class="like-button"><i class="fas fa-thumbs-up"></i> Like</button>
                    </form>
                </div>
            </div>
        </div>
